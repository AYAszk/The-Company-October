        ...
        public function login($request){
            ...
            public function update($request, $files){
                ...
                if($this->conn->query($sql)){
                   ...
                   #If there ia an UPLOADED PHOTO, save it to the DATABASE and copy the image to the images folder.
            ...
            {
              // we need to start the session before we can use the session variable
               session_start();
